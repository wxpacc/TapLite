...
TapLite 面向普通 Windows 桌面场景，不提供反作弊绕过、进程注入、隐藏式后台点击或权限规避能力。

## 下载

- 最新版本页面：https://github.com/wxpacc/TapLite/releases/tag/v0.3.0
- 直接下载：https://github.com/wxpacc/TapLite/releases/download/v0.3.0/TapLite.exe
